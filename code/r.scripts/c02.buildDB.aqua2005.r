...
aqua.2005 <- readRDS("./data/RAW/MODIS.AQUA.TERRA.LST.NDVI/stage2/MYD11A1_2005.rds")
...
# Join NDVI to LST.
fin.ndvi <- readRDS("./data/RAW/MODIS.AQUA.TERRA.LST.NDVI/stage2/MYD13A3_2005.rds")
...
db2005 <- merge(db2005, f.ndvi[,list(ndviid,ndvi,m)], all.x = T)
...
Temp[, day:=as.Date(strptime(date, "%Y-%m-%d"))]
Temp[, c := as.numeric(format(day, "%Y"))]
Temp2005tc <- as.data.frame(Temp)
Temp2005tc <- select(Temp2005tc, stn, day,hi.temp, low.temp, temp.mean, long_stn=X, lat_stn=Y)



#loop min
for(i in unique(db2005$day)) {
  x<-Temp2005tc[Temp2005tc$day==i, ]
...
saveRDS(db2005,"./data/outputs/AQUA/2005/c02/MEXICO.mod3.AQ.2005.rds")
gc()
...
saveRDS(db2005.m2.day,"./data/outputs/AQUA/2005/c02/MEXICO.mod2.AQ.2005.day.rds")
saveRDS(db2005.m2.night,"./data/outputs/AQUA/2005/c02/MEXICO.mod2.AQ.2005.night.rds")
...
#save mod 1
saveRDS(Ta.m1,"./data/outputs/AQUA/2005/c02/MEXICO.mod1.AQ.2005.night.rds")
...
#save mod 1
saveRDS(Ta.m1,"./data/outputs/AQUA/2005/c02/MEXICO.mod1.AQ.2005.day.rds")
...
Ta.m1 <- Ta.m1[!is.na(n.tempc)]
#save mod 1
saveRDS(Ta.m1,"./data/outputs/AQUA/2005/c02/MEXICO.mod1.AQ.2005.mean24.rds")
# ########--------->mod1 mean
# #to fix missing days issues resulting in cartesean error
