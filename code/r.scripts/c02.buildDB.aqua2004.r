...
aqua.2004<-readRDS("R:\\RAW\\MODIS.AQUA.TERRA.LST.NDVI\\stage2\\MYD11A1_2004.rds")
...
#join NDVI to lst
fin.ndvi<-readRDS("R:\\RAW\\MODIS.AQUA.TERRA.LST.NDVI\\stage2\\MYD13A3_2004.rds")
...
saveRDS(db2004,"R:\\work\\MEXICO.mod3.AQ.2004.rds")
gc()
...
saveRDS(db2004.m2.day,"R:\\work\\MEXICO.mod2.AQ.2004.day.rds")
saveRDS(db2004.m2.night,"R:\\work\\MEXICO.mod2.AQ.2004.night.rds")
...
#save mod 1
saveRDS(Ta.m1,"R:\\work\\MEXICO.mod1.AQ.2004.night.rds")
...
#save mod 1
saveRDS(Ta.m1,"R:\\work\\MEXICO.mod1.AQ.2004.day.rds")
...
Ta.m1<-Ta.m1[!is.na(n.tempc)]
#save mod 1
saveRDS(Ta.m1,"R:\\work\\MEXICO.mod1.AQ.2004.mean24.rds")
# ########--------->mod1 mean
# #to fix missing days issues resulting in cartesean error
