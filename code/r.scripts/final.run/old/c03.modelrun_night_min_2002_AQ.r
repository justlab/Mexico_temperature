...
#load data
mod1.n <-readRDS("R:\\work\\MEXICO.mod1.AQ.2002.night.rds")
summary(mod1.n)
...
#save
    saveRDS(mod1.n,"R:\\work\\MEXICO.mod1.2002.AQ.night.min.predm1.rds")
    #save results
    saveRDS(res,"R:\\work\\MEXICO.results.2002.AQ.tempmin.rds")
...
#save
    saveRDS(mod1.n.cv,"R:\\work\\MEXICO.mod1.2002.AQ.night.min.predm1.CV.rds")
#save res   
saveRDS(res,"R:\\work\\MEXICO.results.2002.AQ.tempmin.rds")
...
saveRDS(mod2.n,"R:\\work\\MEXICO.mod2.2002.AQ.night.min.predm2.rds")
...
out<-na.omit(out)
write.csv(out,"R:\\work\\results\\MEXICO.mod2.2002.AQ.min.map.csv")
...
saveRDS(mod3,"R:\\work\\MEXICO.mod3.2002.AQ.night.min.predm3.rds")
...
mod1 <-readRDS("R:\\work\\MEXICO.mod1.2002.AQ.night.min.predm1.rds")
mod1$lstid<-paste(mod1$long_lst,mod1$lat_lst,sep="-")
...
#import mod2.n
mod2.n<- readRDS( "R:\\work\\MEXICO.mod2.2002.AQ.night.min.predm2.rds")
...
#save
saveRDS(mod3best,"R:\\work\\MEXICO.2002.AQ.min.bestpred.rds")
...
out<-na.omit(out)
write.csv(out,"R:\\work\\MEXICO.2002.AQ.min.bestpredmap.csv")
#save res
saveRDS(res,"R:\\work\\MEXICO.results.2002.AQ.tempmin.rds")
