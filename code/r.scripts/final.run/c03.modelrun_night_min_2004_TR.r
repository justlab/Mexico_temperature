...
#sourcing
source("P:\\R.scripts\\CV_splits.r")
source("P:\\R.scripts\\rmspe.r")
...
#load data
mod1.n <-readRDS("R:\\work\\MEXICO.mod1.TR.2004.night.rds")
summary(mod1.n)
...
#save
    saveRDS(mod1.n,"R:\\work\\MEXICO.mod1.2004.TR.night.min.predm1.rds")
    #save results
    saveRDS(res,"R:\\work\\MEXICO.results.2004.TR.tempmin.rds")
 ...
 #---------------->>>> CV
      ...
      #save
      #saveRDS(mod1.n.cv,"/media/NAS/Uni/Projects/P045_Israel_LST/2.work/mod1.n.TR.2004.tempmin.CV.rds")
...
#save
    saveRDS(mod1.n.cv,"R:\\work\\MEXICO.mod1.2004.TR.night.min.predm1.CV.rds")
#save res   
saveRDS(res,"R:\\work\\MEXICO.results.2004.TR.tempmin.rds")
...
mod2.n <- readRDS("R:\\work\\MEXICO.mod2.TR.2004.night.rds")
summary(mod2.n)
...
saveRDS(mod2.n,"R:\\work\\MEXICO.mod2.2004.TR.night.min.predm2.rds")
...
out<-na.omit(out)
write.csv(out,"R:\\work\\results\\MEXICO.mod2.2004.TR.min.map.csv")
...
# 
# #mod 3 (5-8 h)
# mod3 <- readRDS("/media/NAS/Uni/Projects/P045_Israel_LST/2.work/mod2.TR.2004.night.rds")
...
# 
# 
# mod1 <-readRDS("/media/NAS/Uni/Projects/P045_Israel_LST/2.work/mod1.min.TR.2004.tempmin.predm1.rds")
...
#mod 3 (5-8 h)
mod3 <- readRDS("R:\\work\\MEXICO.mod3.TR.2004.rds")
#delete water flags
mod3<-filter(mod3,ndvi > 0)
#kill PA open places
# mod3<-filter(mod3,in_pa  == 0)
# mod3<-filter(mod3,in_water == 0)
# mod3<-filter(mod3,!is.na(open_place_percent))
# mod3<-filter(mod3,!is.na(rhmean))
# mod3<-filter(mod3,!is.na(wsmean))
...
saveRDS(mod3,"R:\\work\\MEXICO.mod3.2004.TR.night.min.predm3.rds")
...
mod3 <-readRDS("R:\\work\\MEXICO.mod3.2004.TR.night.min.predm3.rds")
mod1 <-readRDS("R:\\work\\MEXICO.mod1.2004.TR.night.min.predm1.rds")
mod1$lstid<-paste(mod1$long_lst,mod1$lat_lst,sep="-")
...
#import mod2.n
mod2.n<- readRDS( "R:\\work\\MEXICO.mod2.2004.TR.night.min.predm2.rds")
...
#save
saveRDS(mod3best,"R:\\work\\MEXICO.2004.TR.min.bestpred.rds")
...
out<-na.omit(out)
write.csv(out,"R:\\work\\MEXICO.2004.TR.min.bestpredmap.csv")
#save res
saveRDS(res,"R:\\work\\MEXICO.results.2004.TR.tempmin.rds")
