...
#load data
mod1.n <-readRDS("R:\\work\\MEXICO.mod1.AQ.2002.mean24.rds")
summary(mod1.n)
...
#save
    saveRDS(mod1.n,"R:\\work\\MEXICO.mod1.2002.AQ.night.mean.predm1.rds")
    #save results
    saveRDS(res,"R:\\work\\MEXICO.results.2002.AQ.tempmean.rds")
...
#save
    saveRDS(mod1.n.cv,"R:\\work\\MEXICO.mod1.2002.AQ.night.mean.predm1.CV.rds")
#save res   
saveRDS(res,"R:\\work\\MEXICO.results.2002.AQ.tempmean.rds")
...
mod2.n <- readRDS("R:\\work\\MEXICO.mod2.AQ.2002.night.rds")
summary(mod2.n)
...
saveRDS(mod2.n,"R:\\work\\MEXICO.mod2.2002.AQ.night.mean.predm2.rds")
...
out<-na.omit(out)
write.csv(out,"R:\\work\\results\\MEXICO.mod2.2002.AQ.mean.map.csv")
...
#this is important so that its sorted as in the first gamm   Xpred_1,Xpred_2, Xpred_3,
setkey(mod2.n,day, lstid)
...
#mod 3 (5-8 h)
mod3 <- readRDS("R:\\work\\MEXICO.mod3.AQ.2002.rds")
#delete water flags
...
# create pred.m3    mod3_bimon1,mod3_bimon2,mod3_bimon3,
mod3$pred.m3 <-mod3$pred.m3.mix+mod3$gpred
# hist(mod3$pred.m3)
summary(mod3$pred.m3)
saveRDS(mod3,"R:\\work\\MEXICO.mod3.2002.AQ.night.mean.predm3.rds")
...
mod1 <-readRDS("R:\\work\\MEXICO.mod1.2002.AQ.night.mean.predm1.rds")
mod1$lstid<-paste(mod1$long_lst,mod1$lat_lst,sep="-")
...
#import mod2.n
mod2.n<- readRDS( "R:\\work\\MEXICO.mod2.2002.AQ.night.mean.predm2.rds")
...
#save
saveRDS(mod3best,"R:\\work\\MEXICO.2002.AQ.mean.bestpred.rds")
...
out<-na.omit(out)
write.csv(out,"R:\\work\\MEXICO.2002.AQ.mean.bestpredmap.csv")
#save res
saveRDS(res,"R:\\work\\MEXICO.results.2002.AQ.tempmean.rds")
