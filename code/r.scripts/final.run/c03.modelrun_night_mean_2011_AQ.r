...
#load data
mod1.n <-readRDS("./data/outputs/AQUA/2011/c02/MEXICO.mod1.AQ.2011.mean24.rds")
summary(mod1.n)
...
#save
saveRDS(mod1.n,"./data/outputs/AQUA/2011/c03/MEXICO.mod1.2011.AQ.night.mean.predm1.rds")
#save results
saveRDS(res,"./data/outputs/AQUA/2011/c03/MEXICO.results.2011.AQ.tempmean.rds")
...
#save
#saveRDS(mod1.n.cv,"./data/outputs/AQUA/2011/c03/mod1.n.AQ.2004.tempmean.CV.rds")
...
#save
saveRDS(mod1.n.cv,"./data/outputs/AQUA/2011/c03/MEXICO.mod1.2011.AQ.night.mean.predm1.CV.rds")
#save res   
saveRDS(res,"./data/outputs/AQUA/2011/c03/MEXICO.results.2011.AQ.tempmean.rds")
...
saveRDS(mod2.n,"./data/outputs/AQUA/2011/c03/MEXICO.mod2.2011.AQ.night.mean.predm2.rds")
...
out<-na.omit(out)
write.csv(out,"./data/outputs/AQUA/2011/c03/MEXICO.mod2.2011.AQ.mean.map.csv")
...
saveRDS(mod3,"./data/outputs/AQUA/2011/c03/MEXICO.mod3.2011.AQ.night.mean.predm3.rds")
...
mod1 <-readRDS("./data/outputs/AQUA/2011/c03/MEXICO.mod1.2011.AQ.night.mean.predm1.rds")
mod1$lstid<-paste(mod1$long_lst,mod1$lat_lst,sep="-")
...
#import mod2.n
mod2.n<- readRDS( "./data/outputs/AQUA/2011/c03/MEXICO.mod2.2011.AQ.night.mean.predm2.rds")
...
#save
saveRDS(mod3best,"./data/outputs/AQUA/2011/c03/MEXICO.2011.AQ.mean.bestpred.rds")
...
out<-na.omit(out)
write.csv(out,"./data/outputs/AQUA/2011/c03/MEXICO.2011.AQ.mean.bestpredmap.csv")
#save res
saveRDS(res,"./data/outputs/AQUA/2011/c03/MEXICO.results.2011.AQ.tempmean.rds")
