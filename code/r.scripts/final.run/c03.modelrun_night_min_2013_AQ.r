...
#load data
mod1.n <-readRDS("./data/outputs/AQUA/2013/c02/MEXICO.mod1.AQ.2013.night.rds")
summary(mod1.n)
...
#save
saveRDS(mod1.n,"./data/outputs/AQUA/2013/c03/MEXICO.mod1.2013.AQ.night.min.predm1.rds")
#save results
saveRDS(res,"./data/outputs/AQUA/2013/c03/MEXICO.results.2013.AQ.tempmin.rds")
...
#save
#saveRDS(mod1.n.cv,"./data/outputs/AQUA/2013/c03/mod1.n.AQ.2013.tempmin.CV.rds")
...
#save
saveRDS(mod1.n.cv,"./data/outputs/AQUA/2013/c03/MEXICO.mod1.2013.AQ.night.min.predm1.CV.rds")
#save res   
saveRDS(res,"./data/outputs/AQUA/2013/c03/MEXICO.results.2013.AQ.tempmin.rds")
...
mod2.n <- readRDS("./data/outputs/AQUA/2013/c02/MEXICO.mod2.AQ.2013.night.rds")
summary(mod2.n)
...
saveRDS(mod2.n,"./data/outputs/AQUA/2013/c03/MEXICO.mod2.2013.AQ.night.min.predm2.rds")
...
out<-na.omit(out)
write.csv(out,"./data/outputs/AQUA/2013/c03/MEXICO.mod2.2013.AQ.min.map.csv")
...
#mod 3 (5-8 h)
mod3 <- readRDS("./data/outputs/AQUA/2013/c02/MEXICO.mod3.AQ.2013.rds")
summary(mod3)
#delete water flags
...
saveRDS(mod3,"./data/outputs/AQUA/2013/c03/MEXICO.mod3.2013.AQ.night.min.predm3.rds")
...
mod3 <-readRDS("./data/outputs/AQUA/2013/c03/MEXICO.mod3.2013.AQ.night.min.predm3.rds")
mod1 <-readRDS("./data/outputs/AQUA/2013/c03/MEXICO.mod1.2013.AQ.night.min.predm1.rds")
mod1$lstid<-paste(mod1$long_lst,mod1$lat_lst,sep="-")
...
#import mod2.n
mod2.n<- readRDS( "./data/outputs/AQUA/2013/c03/MEXICO.mod2.2013.AQ.night.min.predm2.rds")
...
#save
saveRDS(mod3best,"./data/outputs/AQUA/2013/c03/MEXICO.2013.AQ.min.bestpred.rds")
...
out<-na.omit(out)
write.csv(out,"./data/outputs/AQUA/2013/c03/MEXICO.2013.AQ.min.bestpredmap.csv")
#save res
saveRDS(res,"./data/outputs/AQUA/2013/c03/MEXICO.results.2013.AQ.tempmin.rds")
