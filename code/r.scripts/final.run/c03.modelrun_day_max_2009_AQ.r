...
mod1.n <- readRDS("./data/outputs/AQUA/2009/c02/MEXICO.mod1.AQ.2009.day.rds")
summary(mod1.n)
...
#save
saveRDS(mod1.n,"./data/outputs/AQUA/2009/c03/MEXICO.mod1.2009.AQ.day.max.predm1.rds")
#save results
saveRDS(res,"./data/outputs/AQUA/2009/c03/MEXICO.results.2009.AQ.tempmax.rds")
...
#save
#saveRDS(mod1.n.cv,"./data/outputs/AQUA/2009/c03/mod1.n.AQ.2009.tempmax.CV.rds")
...
#save
saveRDS(mod1.n.cv,"./data/outputs/AQUA/2009/c03/MEXICO.mod1.2009.AQ.day.max.predm1.CV.rds")
#save res   
saveRDS(res,"./data/outputs/AQUA/2009/c03/MEXICO.results.2009.AQ.tempmax.rds")
...
mod2.n <- readRDS("./data/outputs/AQUA/2009/c02/MEXICO.mod2.AQ.2009.day.rds")
summary(mod2.n)
...
saveRDS(mod2.n,"./data/outputs/AQUA/2009/c03/MEXICO.mod2.2009.AQ.day.max.predm2.rds")
...
out <- na.omit(out)
write.csv(out,"./data/outputs/AQUA/2009/c03/MEXICO.mod2.2009.AQ.max.map.csv")
...
saveRDS(mod3,"./data/outputs/AQUA/2009/c03/MEXICO.mod3.2009.AQ.day.max.predm3.rds")
...
mod1 <-readRDS("./data/outputs/AQUA/2009/c03/MEXICO.mod1.2009.AQ.day.max.predm1.rds")
mod1$lstid<-paste(mod1$long_lst,mod1$lat_lst,sep="-")
...
#import mod2.n
mod2.n<- readRDS( "./data/outputs/AQUA/2009/c03/MEXICO.mod2.2009.AQ.day.max.predm2.rds")
...
#save
saveRDS(mod3best,"./data/outputs/AQUA/2009/c03/MEXICO.2009.AQ.max.bestpred.rds")
...
out<-na.omit(out)
write.csv(out,"./data/outputs/AQUA/2009/c03/MEXICO.2009.AQ.max.bestpredmap.csv")
#save res
saveRDS(res,"./data/outputs/AQUA/2009/c03/MEXICO.results.2009.AQ.tempmax.rds")
