...
for(y in 2002:2015) {
  ...
  d.tempc = readRDS(paste0("MYD11A1_1_", y, ".rds"))
  n.tempc = readRDS(paste0("MYD11A1_5_", y, ".rds"))
  emmisivity = readRDS(paste0("MYD11A1_9_", y, ".rds"))
  ...
  for(j in 1:nlayers(d.tempc)) {
    ...
    d.tempc1 = d.tempc[[j]]
    d.tempc1[is.na(d.tempc1)] = -9999
    n.tempc1 = n.tempc[[j]]
    n.tempc1[is.na(n.tempc1)] = -9999
    emmisivity1 = emmisivity[[j]]
    emmisivity1[is.na(emmisivity1)] = -9999
    result = list(d.tempc1, n.tempc1, emmisivity1)
    ...
    # Back to NA
    result$d.tempc[result$d.tempc == -9999] = NA
    result$n.tempc[result$n.tempc == -9999] = NA
    result$emissivity[result$emissivity == -9999] = NA
  ...
  saveRDS(final, paste0("MOD11A1_", y, ".rds"))
