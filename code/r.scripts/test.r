...
aqua.2002<-readRDS("R:\\RAW\\MODIS.AQUA.TERRA.LST.NDVI\\stage2\\MYD11A1_2002.rds")
...
#join NDVI to lst
fin.ndvi<-readRDS("R:\\RAW\\MODIS.AQUA.TERRA.LST.NDVI\\stage2\\MYD13A3_2002.rds")
...
#add ndvi
setkey(db2002,lstid,m)
setkey(f.ndvi,lstid,m)
db2002 <- merge(db2002, f.ndvi[,list(lstid,ndvi,m)], all.x = T)
...
Temp2002<-as.data.table(Temp2002)
...
saveRDS(db2002,"R:\\work\\MEXICO.mod3.AQ.2002.test.rds")
gc()
...
saveRDS(db2002.m2.day,"R:\\work\\MEXICO.mod2.AQ.2002.day.test.rds")
saveRDS(db2002.m2.night,"R:\\work\\MEXICO.mod2.AQ.2002.night.test.rds")
...
#save mod 1
saveRDS(Ta.m1,"R:\\work\\MEXICO.mod1.AQ.2002.night.test.rds")
...
#save mod 1
saveRDS(Ta.m1,"R:\\work\\MEXICO.mod1.AQ.2002.day.test.rds")
...
Ta.m1<-Ta.m1[!is.na(n.tempc)]
#save mod 1
saveRDS(Ta.m1,"R:\\work\\MEXICO.mod1.AQ.2002.mean24.rds")
# ########--------->mod1 mean
# #to fix missing days issues resulting in cartesean error
