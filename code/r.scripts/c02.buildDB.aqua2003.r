...
source("/media/qnap/Projects/P018.IL.Israel.LST.Ta/R.scripts/geomerge_alpha.r")

#import clipped grid
fullgrid<-fread("/media/qnap/Projects/P029.MX.DF.LST.Ta/work/mexico_grid_ndvi_water_final.csv")
...
#load met
Temp<-readRDS("/media/qnap/Projects/P029.MX.DF.LST.Ta/work/all_stations_final.rds")
...
aqua.2003<-readRDS("/media/qnap/Projects/P029.MX.DF.LST.Ta/RAW/MODIS.AQUA.TERRA.LST.NDVI/stage2/MYD11A1_2003.rds")
...
#join NDVI to lst
fin.ndvi<-readRDS("/media/qnap/Projects/P029.MX.DF.LST.Ta/RAW/MODIS.AQUA.TERRA.LST.NDVI/stage2/MYD13A3_2003.rds")
...
saveRDS(db2003,"/media/qnap_eea/Projects/P029.MX.DF.LST.Ta/work/MEXICO.mod3.AQ.2003.rds")
gc()
...
saveRDS(db2003.m2.day,"/media/qnap_eea/Projects/P029.MX.DF.LST.Ta/work/MEXICO.mod2.AQ.2003.day.rds")
saveRDS(db2003.m2.night,"/media/qnap_eea/Projects/P029.MX.DF.LST.Ta/work/MEXICO.mod2.AQ.2003.night.rds")
...
#save mod 1
saveRDS(Ta.m1,"/media/qnap_eea/Projects/P029.MX.DF.LST.Ta/work/MEXICO.mod1.AQ.2003.night.rds")
...
#save mod 1
saveRDS(Ta.m1,"/media/qnap_eea/Projects/P029.MX.DF.LST.Ta/work/MEXICO.mod1.AQ.2003.day.rds")
...
Ta.m1<-Ta.m1[!is.na(n.tempc)]
#save mod 1
saveRDS(Ta.m1,"/media/qnap_eea/Projects/P029.MX.DF.LST.Ta/work/MEXICO.mod1.AQ.2003.mean24.rds")
# ########--------->mod1 mean
# #to fix missing days issues resulting in cartesean error
